...
symptom_synonyms = {
    ...
    'fever': ['high temperature', 'elevated temperature', 'feverish'],
    'cough': ['persistent cough', 'dry cough', 'wet cough'],
    ...
    'shortness of breath': ['difficulty breathing', 'labored breathing', 'breathing problems'],
...
def extract_symptoms(text, use_fuzzy=True):
    ...
    try:
        ...
        if use_fuzzy:
            ...
            threshold = 94  # Set a threshold for matching (0-100)
